...
public class Person {
	...
	// bi-directional. Owned by Anlass
	...
	public List<Anlass> getOrganisierteAnlaesse() {
		return organisierteAnlaesse;
	}

	public void setOrganisierteAnlaesse(List<Anlass> organisierteAnlaesse) {
		this.organisierteAnlaesse = organisierteAnlaesse;
	}
